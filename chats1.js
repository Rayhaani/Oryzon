        ...
        async function renderMyPages() {
            ...
            try {
                ...
                pageDocs.filter(p => p.exists).forEach(p => {
                    ...
                    row.onclick = () => { window.location.href = `pages.html?page=${encodeURIComponent(pid)}`; };
                    row.innerHTML = `
       ...
       function triggerOptionAction(action) {
        ...
        async function gcoCreateGroup() {
            ...
            try {
                ...
                pendingInvites = [];
                window.location.href = 'group.html?group=' + encodeURIComponent(finalSlug);
            } catch (e) {
        ...
        async function pcoCreatePage() {
            ...
            try {
                ...
                pendingInvites = [];
                window.location.href = 'pages.html?page=' + encodeURIComponent(finalSlug);
            } catch (e) {
    ...
    if (tabId !== 'friends') {
        ...
        function apvMessageAction() {
            ...
            if (apvCurrentTarget && apvCurrentTarget.chatHref) {
                ...
                window.location.href = apvCurrentTarget.chatHref + sep + 'autofocus=1';
            }
        }
        function apvInfoAction() {
            closeAvatarPhotoViewer();
            if (apvCurrentTarget && apvCurrentTarget.infoHref) window.location.href = apvCurrentTarget.infoHref;
        }
