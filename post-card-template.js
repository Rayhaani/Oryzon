...
window.generatePostHTML = function(post) {
    ...
    ">
        ...
        <div class="post-header" style="display: flex !important; align-items: center !important; justify-content: space-between !important; padding: 6px 15px 6px 54px !important; height: auto !important; min-height: 46px !important; position: relative !important;">
            <a href="me.html?user=${encodeURIComponent(post.username || '')}"
               style="position:absolute; left:0; top:50%; transform: translateY(-50%); width:42px; height:42px; display:block; z-index:20; text-decoration:none; margin-left: 6px;">
                <img src="${avatarUrl}"
                     class="post-avatar"
                     loading="lazy"
                     alt="${post.username}"
                     style="position: static !important; width: 100% !important; height: 100% !important;">
            </a>

            <div class="post-username-row" style="display: flex !important; flex-direction: column !important; justify-content: center !important; flex: 1 !important; background: none !important; border: none !important; padding: 0 !important; margin: 0 0 0 6px !important;">
                <div>
                    <div style="display:flex; align-items:center; gap:5px; line-height:1.2;">
                        <span class="post-username" style="font-size:18px !important; font-weight:900 !important; color:#fff; display:block;">${post.username || 'unknown'}</span>
