...
<div class="post-username-row" style="display: flex !important; flex-direction: column !important; justify-content: center !important; flex: 1 !important; min-width: 0 !important; margin: 0 0 0 2px !important;">
    ...
    <div style="display:flex; align-items:center; gap:1px; line-height:1.2; min-width:0; margin-top:3px;">
        <span class="post-fullname" style="font-family: inherit; font-size:14px !important; font-weight:900; color:#fff !important; letter-spacing:0.2px; text-shadow: 0 1px 3px rgba(0,0,0,0.55), 0 0 1px rgba(0,0,0,0.4), 0 0 6px rgba(255,255,255,0.25); position:relative; top:1px; flex:0 1 auto; min-width:0; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">${post.fullName || post.username || 'unknown'}</span>
