...
function renderReviewsSection(reviews) {
    ...
    if (summaryEl) {
        summaryEl.innerHTML = count > 0
            ...
            : `<span style="font-size:13px;color:rgba(245,245,220,0.5);">Babu reviews tukuna — ka zama na farko!</span>`;
    }
...
let _pp_collection, _pp_addDoc, _pp_getDocs, _pp_query, _pp_orderBy, _pp_serverTimestamp;
async function ensureProductsPageFirebase() {
    ...
    const { getFirestore, doc, getDoc, collection, addDoc, getDocs, query, orderBy, serverTimestamp } = await import("https://www.gstatic.com/firebasejs/11.0.0/firebase-firestore.js");
