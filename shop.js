...
// bootProductsPage/destroyProductsPage ana kiran su daga waje (openProductsPageOverlay/
// closeProductsPageOverlay, wanda ke zaune a wani IIFE dabam) — sauran kuma HTML
// onclick="..." ne ke kiransu kai tsaye. Komai kuma (qty, selectedColor, popTimer,
// selectedStars, currentUser, da sauransu) ya rage a boye, domin kada su ci karo da
// wata page dabam (misali social.html) da take amfani da irin wadannan sunaye gama-gari.
window.bootProductsPage = bootProductsPage;
window.destroyProductsPage = destroyProductsPage;
window.closeFS = closeFS;
window.closeInf = closeInf;
window.closeModal = closeModal;
window.expandVisualProof = expandVisualProof;
window.infProceed = infProceed;
window.openHeroFS = openHeroFS;
window.openVisualProofFS = openVisualProofFS;
window.rate = rate;
window.selectColor = selectColor;
window.selectQuickMsg = selectQuickMsg;
window.sendVendorMsg = sendVendorMsg;
