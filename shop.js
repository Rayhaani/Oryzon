...
async function bootShopMarketplace() {
    ...
    try {
        ...
        // navigates back to shop.html in the same SPA session. Cache it
        // once at module scope and reuse it on every re-run instead.
        if (!_shopFbApp) {
            _shopFbApp = initializeApp(firebaseConfig);
        ...
        function goToProduct(product) {
            ...
            NexusRouter.navigateTo(`products-page.html?id=${product.id}`);
        }
