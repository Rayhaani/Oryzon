    ...
    if (tabId !== 'friends') {
        ...
        function apvMessageAction() {
            ...
            if (apvCurrentTarget && apvCurrentTarget.chatHref) {
                ...
                // group.html kadai ke SPA-ready a yanzu — sauran (page/
                // channel/friend) na ci gaba da full reload kamar da.
                if (apvCurrentTarget.kind === 'group' && window.NexusRouter && typeof window.NexusRouter.navigateTo === 'function') {
