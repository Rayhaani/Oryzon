...
function initHealthPage() {
    ...
    // health.html YANZU tana amfani da shared bottom-nav footer kamar
    // sauran pages. (An CIRE lambobin da suka boye footer din a nan —
    // su ne ke haddasa footer ta "yi rawa" (transform slide-out) sannan
    // ta kasance ba za a iya danna icons dinta ba lokacin da ake cikin
    // health.html, domin CSS din .footer-hidden take footer din waje
    // da screen har sai an bar health.html.)
}
