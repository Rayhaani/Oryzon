/* ============================================================
   ...
   ============================================================ */
    ...
    // ===== FIREBASE (guarded domin kada a sake yin initializeApp
    //      idan an rigaya an kira shi daga wata page ta SPA) =====
    ...
    // Ba a saka shi const domin a sake karanta shi kowane pageInit()
    // (idan session ta canja tsakanin lokacin da aka bar page din
    // sannan aka dawo ta SPA).
    let currentUser = localStorage.getItem('nexus_user_session');
...
// ============================================================
function pageInit() {
    currentUser = localStorage.getItem('nexus_user_session');
