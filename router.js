...
(function () {
    ...
    const PAGE_SCRIPTS = {
        ...
        // MUHIMMI: me.html/nexus-feed.html suna amfani da nexus-core.js
        // (iri daya da social.html) domin firebase.initializeApp()/db/
        // storage/analytics/currentUser — me.js/nexus-feed.js BA SA
        // sake yin firebase.initializeApp() na kansu. An daidaita
        // dukansu biyu zuwa EXACT SAME firebase 10.7.1 URLs (kalma-da-
        // kalma iri daya da na social.html a sama) domin loadedScripts
        // Set ya gane su a matsayin "an riga an loda" ko ta wace page
        // ce user ya fara.
        // (videos.html BA route ba ne yanzu — videos.js overlay ne a
        // cikin social.html kadai, duba comment a saman videos.js.)
        'me.html': [
            'https://www.gstatic.com/firebasejs/10.7.1/firebase-app-compat.js',
            'https://www.gstatic.com/firebasejs/10.7.1/firebase-auth-compat.js',
            'https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore-compat.js',
