/* ============================================================
   NEXUS OVERLAY ROUTER — overlay-router.js (v1.4 — PHASE 1, FIX)
   ------------------------------------------------------------
   ...
   which was proven fine for the back button. Keeping v1.3's other
   fix (#5, the firebaseConfig rename) since that one is unrelated
   and correct. The footer-bleed-through issue itself is UNSOLVED
   again for now — need footer.js to fix it properly instead of
   guessing another selector.
