   ...
   window.updateChatFooterBadge = function (hasUnread) {
    ...
    function injectFooter() {
        ...
        if (existing) {
            ...
            setActiveIcon();
            loadFooterProfile();
            // pinFooterToVisualViewport(); // an kashe don gwaji, duba sama
            return;
        }
        ...
        loadFooterProfile();
        setupScrollBehavior();
        // GWAJI: an kashe wannan na wucin-gadi domin gwada ko native
        // position:fixed (babu JS) yake gyara "tsalle" din da kansa,
        // domin JS din nan yana iya zama shi kansa asalin tsallen —
        // idan an tabbatar babu jump bayan an kashe ta, a CIRE wannan
        // function gaba daya (da kiran ta a layi 350/373 kasa).
